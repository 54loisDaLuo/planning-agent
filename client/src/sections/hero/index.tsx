...
export default function Hero() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center hero-gradient-bg">
      <h1 className="text-6xl font-bold mb-16 text-plagt-blue-1">
        {/* 专项规划 Agent */}
        智策云笔
      </h1>
      <h1 className="text-5xl font-medium mb-16 text-plagt-blue-1">
        {/* 专项规划 Agent */}
        基于知识库的报告撰写与实时问答平台
      </h1>
      {/* <div
        className="mb-3 text-base text-plagt-grey-txt"
        style={{ color: 'var(--plagt-grey-txt)' }}
      >
        请输入规划标题
      </div> */}
      <input
